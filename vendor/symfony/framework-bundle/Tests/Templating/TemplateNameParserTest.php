...
class TemplateNameParserTest extends TestCase
{
    ...
    public function parseProvider()
    {
        return [
            ...
            ['FooBundle:Post:showContent.html.twig', 'FooBundle:Post:showContent.html.twig', '@FooBundle/Resources/views/Post/showContent.html.twig', new TemplateReference('FooBundle', 'Post', 'index', 'html', 'twig')],
