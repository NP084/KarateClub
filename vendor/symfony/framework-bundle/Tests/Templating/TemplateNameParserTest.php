...
class TemplateNameParserTest extends TestCase
{
    ...
    public function parseProvider()
    {
        return [
            ...
            ['FooBundle:Post:philosophy.html.twig', 'FooBundle:Post:philosophy.html.twig', '@FooBundle/Resources/views/Post/philosophy.html.twig', new TemplateReference('FooBundle', 'Post', 'index', 'html', 'twig')],
