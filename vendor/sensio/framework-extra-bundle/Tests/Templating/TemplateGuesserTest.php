...
class TemplateGuesserTest extends \PHPUnit\Framework\TestCase
{
    ...
    public function testGuessTemplateName()
    {
        ...
        $this->assertEquals('@Foo/foo/showContent.html.twig', (string) $templateReference);
    }
    ...
    public function testGuessTemplateWithoutBundle()
    {
        ...
        $this->assertEquals('my_admin/out_of_bundle/showContent.html.twig', (string) $templateReference);
    }
