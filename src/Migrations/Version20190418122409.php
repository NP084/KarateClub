 ...
 */
final class Version20190418122409 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE attached_file DROP pathway');
    }
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE attached_file ADD pathway VARCHAR(255) NOT NULL COLLATE utf8mb4_unicode_ci');
