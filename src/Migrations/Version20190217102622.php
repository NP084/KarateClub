 ...
 */
final class Version20190217102622 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE adress (id INT AUTO_INCREMENT NOT NULL, type VARCHAR(255) NOT NULL, num VARCHAR(255) NOT NULL, post_box VARCHAR(255) DEFAULT NULL, street_name VARCHAR(255) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
