 ...
 */
final class Version20190421130744 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE attached_file (id INT AUTO_INCREMENT NOT NULL, member_id INT DEFAULT NULL, status_id INT DEFAULT NULL, title VARCHAR(255) NOT NULL, description LONGTEXT NOT NULL, datecreat DATETIME DEFAULT NULL, docname VARCHAR(255) DEFAULT NULL, INDEX IDX_B010289A7597D3FE (member_id), INDEX IDX_B010289A6BF700BD (status_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE registration (id INT AUTO_INCREMENT NOT NULL, user_id INT NOT NULL, vika_event_id INT NOT NULL, profil_tarif_id INT DEFAULT NULL, userconnected_id_id INT NOT NULL, registration_date DATETIME NOT NULL, remark LONGTEXT DEFAULT NULL, minor TINYINT(1) DEFAULT NULL, medical_care TINYINT(1) DEFAULT NULL, image_diffusion TINYINT(1) DEFAULT NULL, gdpr TINYINT(1) DEFAULT NULL, condition_registration TINYINT(1) NOT NULL, tarif_profil INT NOT NULL, INDEX IDX_62A8A7A7A76ED395 (user_id), INDEX IDX_62A8A7A754707435 (vika_event_id), UNIQUE INDEX UNIQ_62A8A7A729957FF4 (profil_tarif_id), UNIQUE INDEX UNIQ_62A8A7A7C903FE1D (userconnected_id_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE userConnected (id INT AUTO_INCREMENT NOT NULL, user_id INT DEFAULT NULL, name VARCHAR(255) NOT NULL, email VARCHAR(255) NOT NULL, username VARCHAR(255) NOT NULL, password VARCHAR(255) NOT NULL, firstname VARCHAR(255) NOT NULL, birthday DATE NOT NULL, created_user DATETIME NOT NULL, reset_token VARCHAR(255) DEFAULT NULL, UNIQUE INDEX UNIQ_560B3B76A76ED395 (user_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
