 ...
 */
final class Version20190509162545 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE paiement ADD is_paid TINYINT(1) DEFAULT NULL, CHANGE modality_id category_id INT NOT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE paiement DROP is_paid, CHANGE category_id modality_id INT NOT NULL');
    }
}
