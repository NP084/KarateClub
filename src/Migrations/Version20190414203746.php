 ...
 */
final class Version20190414203746 extends AbstractMigration
{
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE app_user ADD CONSTRAINT FK_88BDF3E97E3C61F9 FOREIGN KEY (owner_id) REFERENCES userConnected (id) ON UPDATE NO ACTION ON DELETE NO ACTION');
