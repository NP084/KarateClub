...
// Returns the private 'App\Repository\UserConnectedRepository' shared autowired service.
...
include_once $this->targetDirs[3].'\\src\\Repository\\UserConnectedRepository.php';

return $this->privates['App\Repository\UserConnectedRepository'] = new \App\Repository\UserConnectedRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
