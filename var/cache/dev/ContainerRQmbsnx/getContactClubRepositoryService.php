...
// Returns the private 'App\Repository\ContactClubRepository' shared autowired service.
...
include_once $this->targetDirs[3].'\\src\\Repository\\ContactClubRepository.php';

return $this->privates['App\Repository\ContactClubRepository'] = new \App\Repository\ContactClubRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
