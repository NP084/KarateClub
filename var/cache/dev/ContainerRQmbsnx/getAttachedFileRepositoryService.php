...
// Returns the private 'App\Repository\AttachedFileRepository' shared autowired service.
...
include_once $this->targetDirs[3].'\\src\\Repository\\AttachedFileRepository.php';

return $this->privates['App\Repository\AttachedFileRepository'] = new \App\Repository\AttachedFileRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
