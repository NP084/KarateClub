...
// Returns the private 'App\Repository\ContactListRepository' shared autowired service.
...
include_once $this->targetDirs[3].'\\src\\Repository\\ContactListRepository.php';

return $this->privates['App\Repository\ContactListRepository'] = new \App\Repository\ContactListRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
