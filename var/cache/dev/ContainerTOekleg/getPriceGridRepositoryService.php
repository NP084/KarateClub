...
// Returns the private 'App\Repository\PriceGridRepository' shared autowired service.
...
include_once $this->targetDirs[3].'\\src\\Repository\\PriceGridRepository.php';

return $this->privates['App\Repository\PriceGridRepository'] = new \App\Repository\PriceGridRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
