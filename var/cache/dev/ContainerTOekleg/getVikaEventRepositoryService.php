...
// Returns the private 'App\Repository\VikaEventRepository' shared autowired service.
...
include_once $this->targetDirs[3].'\\src\\Repository\\VikaEventRepository.php';

return $this->privates['App\Repository\VikaEventRepository'] = new \App\Repository\VikaEventRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
