...
// Returns the private 'App\Repository\ContentPageRepository' shared autowired service.
...
include_once $this->targetDirs[3].'\\src\\Repository\\ContentPageRepository.php';

return $this->privates['App\Repository\ContentPageRepository'] = new \App\Repository\ContentPageRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
