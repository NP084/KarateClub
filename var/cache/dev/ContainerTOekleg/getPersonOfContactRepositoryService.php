...
// Returns the private 'App\Repository\PersonOfContactRepository' shared autowired service.
...
include_once $this->targetDirs[3].'\\src\\Repository\\PersonOfContactRepository.php';

return $this->privates['App\Repository\PersonOfContactRepository'] = new \App\Repository\PersonOfContactRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
