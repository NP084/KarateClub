...
include_once $this->targetDirs[3].'\\vendor\\doctrine\\doctrine-fixtures-bundle\\FixtureGroupInterface.php';
...
include_once $this->targetDirs[3].'\\src\\DataFixtures\\VikaFixtures.php';

$a = new \Doctrine\Bundle\FixturesBundle\Loader\SymfonyFixturesLoader($this);
$a->addFixtures([0 => ['fixture' => new \App\DataFixtures\AppFixtures(), 'groups' => []], 1 => ['fixture' => new \App\DataFixtures\ArticlesFixtures(), 'groups' => []], 2 => ['fixture' => new \App\DataFixtures\UserFixtures(($this->services['security.password_encoder'] ?? $this->load('getSecurity_PasswordEncoderService.php'))), 'groups' => []], 3 => ['fixture' => new \App\DataFixtures\VikaFixtures(), 'groups' => []]]);
