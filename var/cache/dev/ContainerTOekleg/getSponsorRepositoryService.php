...
// Returns the private 'App\Repository\SponsorRepository' shared autowired service.
...
include_once $this->targetDirs[3].'\\src\\Repository\\SponsorRepository.php';

return $this->privates['App\Repository\SponsorRepository'] = new \App\Repository\SponsorRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
