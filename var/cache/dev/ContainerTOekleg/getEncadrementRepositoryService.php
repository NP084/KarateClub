...
// Returns the private 'App\Repository\EncadrementRepository' shared autowired service.
...
include_once $this->targetDirs[3].'\\src\\Repository\\EncadrementRepository.php';

return $this->privates['App\Repository\EncadrementRepository'] = new \App\Repository\EncadrementRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
